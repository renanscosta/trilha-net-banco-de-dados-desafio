...
IF NOT EXISTS(SELECT 1
    FROM sys.objects
    WHERE object_id = OBJECT_ID('dbo.Atores')
    AND type = 'U')
BEGIN
...
IF NOT EXISTS(SELECT 1
	FROM sys.objects
	WHERE object_id = OBJECT_ID('dbo.ElencoFilme')
	AND type = 'U')
BEGIN
...
IF NOT EXISTS(SELECT 1
	FROM sys.objects
	WHERE object_id = OBJECT_ID('dbo.Filmes')
	AND type = 'U')
BEGIN
...
IF NOT EXISTS(SELECT 1
	FROM sys.objects
	WHERE object_id = OBJECT_ID('dbo.FilmesGenero')
	AND type = 'U')
BEGIN
...
IF NOT EXISTS(SELECT 1
	FROM sys.objects
	WHERE object_id = OBJECT_ID('dbo.Generos')
	AND type = 'U')
BEGIN
